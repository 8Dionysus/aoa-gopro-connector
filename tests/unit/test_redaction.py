...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"device-id": "synthetic-device"},
        {"deviceId": "synthetic-device"},
        {"cameraIdentifier": "synthetic-device"},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Observed SSID: synthetic-network",
        "API token = synthetic-secret-value",
        "Camera serial number was C1234567890123",
        "WPA PSK: synthetic-psk",
        "Admin PIN: synthetic-pin",
        "Wi-Fi passphrase: synthetic-passphrase",
        "BLE pairing code: synthetic-pairing-code",
        "Pre-shared key: synthetic-pre-shared-key",
        "Recovery code: synthetic-recovery-code",
